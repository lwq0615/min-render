...
import { hookKeys, LIFE } from './types/instance'
...
function getObjectProxy(obj: any, parentProxyData?: ProxyData, key?: ObjectKey) {
...
function getArrayProxy(arr: any[], parentProxyData?: ProxyData, key?: ObjectKey): any[] {
...
export function getProxy(obj: any, parentProxyData?: ProxyData, key?: ObjectKey): any {
...
export function reactive<T>(defaultStore?: T): T {
  if (defaultStore !== void 0 && !Array.isArray(defaultStore) && !isObject(defaultStore)) {
    throw new Error('the param of reactive must be a object or array')
  }
